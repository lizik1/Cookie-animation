...
tl.fromTo('.cookie', {opacity: 0, x:-50, rotation: '-45deg'}, {opacity: 1, x:0, rotation: '0deg'}, '<10%')
tl.fromTo('.text', {x: 30, opacity: 0}, {x: 0, opacity: 1}, '<')

// Cookie-jump
tl.fromTo('.cookie', {y: 0, rotation: '0deg'}, {y: -20, rotation: '-20deg', yoyo: true, repeat: -1})
tl.fromTo('#Group_6', {y: 0}, {y: -20, yoyo: true, repeat: -1}, '<')
tl.fromTo('#Group_7', {y: 0}, {y: -20, yoyo: true, repeat: -1}, '<')
